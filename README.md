 ...
 * The [install.sh](install.sh) script currently is using Immich v1.112.1. It should be noted that due to the fast-evolving nature of Immich, the install script may get broken if you replace the `$TAG` to something more recent.
