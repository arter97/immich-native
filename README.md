 ...
 * The [install.sh](install.sh) script currently is using Immich v2.4.0. It should be noted that due to the fast-evolving nature of Immich, the install script may get broken if you replace the `$REV` to something more recent.
