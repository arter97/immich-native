 ...
 * The [install.sh](install.sh) script currently is using Immich v3.0.1. It should be noted that due to the fast-evolving nature of Immich, the install script may get broken if you replace the `$REV` to something more recent.
